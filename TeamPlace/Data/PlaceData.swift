...
extension Place {
    static func all() -> [Place] {
        return [
            Place(name: "Meeting Room 1", imageURL: "meetingroom1", address: "포항 남구 123", phoneNum: "054-131-345", wish: true, latitude: 36.014, longitude: 129.3257),
            ...
            Place(name: "Coffee Nearme", imageURL: "cafe1", address: "포항 북구 312", phoneNum: "054-2356-2313", wish: true, latitude: 36.12, longitude: 129.323),
